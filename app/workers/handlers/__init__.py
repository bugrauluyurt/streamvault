...
from .validation_handler import handle_validate_and_store

JobHandler = Callable[[Job, AsyncSession], Awaitable[dict]]

HANDLERS: dict[JobType, JobHandler] = {
    JobType.SCRAPE_TOP_TEN: handle_scrape_top_ten,
    JobType.SCRAPE_POPULAR: handle_scrape_popular,
    JobType.VALIDATE_AND_STORE: handle_validate_and_store,
}
